        ...
        <div className={styles.pageContainer}>
            ...
            <div className={styles.teamSectionWrapper}> 
                <div className={styles.teamIntro}>
                    ...
                    <h2 className={styles.subHeading}>Meet the Oak Hill Farms Team</h2>
                    <p className={styles.bodyText}>Our dedicated and experienced staff are the heart of Oak Hill Farms. We share a passion for horses and a commitment to providing exceptional care, expert instruction, and a welcoming environment for everyone.</p>
                </div>
                ...
                <div className={styles.staffList}>
                    {staffMembers.map((member, index) => (
                        <div key={member.id} className={styles.staffCard}>
                            ...
                            <div className={`${styles.staffBioLayout} ${index % 2 !== 0 ? styles.layoutReverse : ''}`}>
