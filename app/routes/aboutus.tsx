...
import Pxl20250308163707963Jpg from '../../src/assets/pxl_20250308_163707963.jpg';
            ...
            <div className={styles.contentWrapper}>
                <div className={styles.heroSection}>
                    <div className={styles.heroImageContainer}>
                        <img src={Pxl20250308163707963Jpg} alt="Oak Hill Farm landscape" className={styles.heroImage} />
                    </div>
                </div>
                ...
                <div className={styles.infoSection}>
                    <div className={styles.infoContent}>
                        <h2>Our Story</h2>
                        <p>
                            Nestled in the heart of rolling hills, our ranch offers a serene haven for horse lovers and nature enthusiasts alike. 
                            With acres of lush pastures, state-of-the-art facilities, and a team dedicated to the care and training of our magnificent horses, 
                            Oak Hill Farms is more than just a ranch—it's a place where memories are made, and a love for horses is shared.
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.teamSection}>
                    ...
                    <p className={styles.teamIntro}>
                        Our dedicated and experienced staff are the heart of Oak Hill Farms. We share a passion for horses and a commitment to providing exceptional care, 
                ...
                <div className={styles.facilitySection}>
                    ...
                    <div className={styles.facilityContent}>
                        <div className={styles.facilityText}>
                            <p>
                                Our ranch boasts exceptional amenities designed to support both horses and riders. We offer five spacious stalls, 
                                a well-equipped tack room, and a round pen for training and groundwork. Our expansive facility includes seven lush paddocks, 
                                an 80 x 160 arena for riding and events, and access to scenic horse trails.
                            </p>
                        </div>
                        <div className={styles.facilityImages}>
                            <img src={Pxl20250308162929633Copy1Jpg} alt="Oak Hill Farm facility" className={styles.facilityImage} />
                            <img src={Pxl20250308162929633Jpg} alt="Oak Hill Farm arena" className={styles.facilityImage} />
                        </div>
                    </div>
                </div>
            </div>
