        ...
        <div className="pageContainer">
            ...
            <div className="contactSection">
                <div className="contentWrapper">
                    ...
                    <h2 className="subHeading">3. BOOKING AND PAYMENT TERMS (SERVICE)</h2>
                    <p className="bodyText">
                    ...
                    <h2 className="subHeading">4. USER OBLIGATIONS (SERVICE)</h2>
                    <p className="bodyText">
                    ...
                    <h2 className="subHeading">5. LIABILITY DISCLAIMER & WAIVER</h2>
                    <p className="bodyText">
                    ...
                    <h2 className="subHeading">6. MODIFICATIONS TO LEGAL TERMS</h2>
                    <p className="bodyText">
