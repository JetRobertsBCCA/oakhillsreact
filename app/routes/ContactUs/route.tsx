    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.headerBar}>
        <div className={styles.headerContent}>
          <div className={styles.navLeft}>
            <a href="/routes/AboutUs#about-section" className={styles.navLinkLeft}>About</a>
            <a href="/routes/AboutUs#features-section" className={styles.navLinkLeft}>Features</a>
            <a href="/routes/AboutUs#testimonials-section" className={styles.navLinkLeft}>Testimonials</a>
          </div>
          <div className={styles.navRight}>
            <Link to="/routes/AboutUs" className={styles.navLinkRight}>About Us</Link>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.contactInfo}>
            ...
            <p>
              ...
              Follow us on our social media channels for the latest updates, events, and pictures!
            </p>
            <ul>
              <li>
                Facebook: <a href="https://facebook.com/oakhillfarms" target="_blank" rel="noopener noreferrer">facebook.com/oakhillfarms</a> {/* Replace placeholder */}
              </li>
              <li>
                Instagram: <a href="https://instagram.com/oakhillfarms" target="_blank" rel="noopener noreferrer">@oakhillfarms</a> {/* Replace placeholder */}
              </li>
              <li>
                Twitter: <a href="https://twitter.com/oakhillfarms" target="_blank" rel="noopener noreferrer">@oakhillfarms</a> {/* Replace placeholder */}
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className={styles.locationSection}>
         <div className={styles.locationContent}>
            ...
            <Link to="/waitlist" className={styles.button}>Join Waitlist</Link>
         </div>
      </div>
      <div className={styles.footerSection}>
         <div className={styles.footerLinks}>
            ...
            <Link to="/routes/ContactUs" className={styles.footerLink}>Contact Us</Link>
         </div>
